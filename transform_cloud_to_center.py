...
def main():
    ...
    template_ply_cloud = plyfile.PlyData.read("/home/gao/Desktop/colimator_template_iit.ply")
    print("Done.")
    ...
    template_ply_cloud.write("/home/gao/Desktop/colimator_template_iit_centered.ply")
